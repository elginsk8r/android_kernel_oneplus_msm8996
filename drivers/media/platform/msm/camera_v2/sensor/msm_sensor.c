...
int msm_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (s_ctrl->front_camera_name &&(((!strcmp(s_ctrl->front_camera_name, "IMX179")) && msm_sensor_id_by_mask(s_ctrl, chipid) == 0x3108) ||
		((!strcmp(s_ctrl->front_camera_name, "S5K3P8")) && msm_sensor_id_by_mask(s_ctrl, chipid) == 0x179))) {
